  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-center pt-1 relative items-center bg-red-500 text-white",
        caption_label: "text-sm font-medium",
        nav: "space-x-1 flex items-center bg-green-500 text-white",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100"
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1 text-3xl",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 bg-red-500 text-white  "
        ),
        day_range_end: "day-range-end",
        day_selected:"bg-green-500"
        ,
        day_today: " bg-orange-300",
        day_outside:
